                                ...
                                <div class="card">
                                    <div class="card-header pb-0">
                                        <div class="d-flex align-items-center">
                                            <p class="mb-0">Thông tin trạng thái</p>
                                                <button class="btn btn-primary btn-sm ms-auto" type="submit" name="update-status">Lưu Lại</button>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="status" class="form-control-label">Tên trạng thái</label>
                                                    <input class="form-control" id="status" type="text" placeholder="Đang làm việc" name="status" value="<?php echo $dataStatusID['status']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
