                                    ...
                                    <div class="card-header pb-0">
                                        <div class="d-flex align-items-center">
                                            <p class="mb-0">Thông tin cấp bậc</p>
                                                <button class="btn btn-primary btn-sm ms-auto" type="submit" name="save-level">Lưu Lại</button>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="level" type="text" placeholder="Senior" name="level" value="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
