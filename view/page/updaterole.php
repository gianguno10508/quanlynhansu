                                ...
                                <div class="card">
                                    <div class="card-header pb-0">
                                        <div class="d-flex align-items-center">
                                            <p class="mb-0">Thông tin chức vụ</p>
                                                <button class="btn btn-primary btn-sm ms-auto" type="submit" name="update-role">Lưu Lại</button>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="chucvu" class="form-control-label">Tên chức vụ</label>
                                                    <input class="form-control" id="chucvu" type="text" placeholder="Leader" name="chucvu" value="<?php echo $dataRole['chucvu']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
