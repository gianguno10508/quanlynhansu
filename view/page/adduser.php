                                ...
                                <div class="card">
                                    <div class="card-header pb-0">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <button class="btn btn-primary btn-sm ms-auto" type="submit" name="save-user">Lưu Lại</button>
                                        </div>
                                        <?php
                                        if (isset($check) && $check == 0) {
                                            ?>
                                            <p style="color: #ee001d;">Mã nhân viên và email đã tồn tại vui lòng kiểm tra lại!</p>
                                            <?php
                                        }
                                        ?>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="manhanvien" type="text" placeholder="NV1" name="manhanvien" value="">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="fullname" class="form-control-label">Họ và Tên</label>
                                                    <input class="form-control" id="fullname" type="text" placeholder="ABC" name="fullname" value="">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="email" class="form-control-label">Email</label>
                                                    <input class="form-control" type="email" id="email" name="email" placeholder="abc@gmail.com" value="">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="password" class="form-control-label">Mật khẩu</label>
                                                    <input class="form-control" type="password" placeholder="*******" id="password" name="password" value="">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="0123456789" name="phone" id="phone" type="number" value="">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="address" class="form-control-label">Địa chỉ</label>
                                                    <input class="form-control" type="text" id="address" name="address" placeholder="Thái Nguyên" value="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
